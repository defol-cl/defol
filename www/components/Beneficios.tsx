            ...
            <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center  text-left">
                ...
                <dl className="mt-10 space-y-10 ">
                  <div className="relative">
                    <dt>
                      ...
                      <p className="ml-16 text-lg leading-6 font-medium text-gray-900">
                        Otorga acceso gratuito a tus colaboradores y
                        stakeholders
                      </p>
                    </dt>
                  ...
                  <div className="relative">
                    <dt>
                      ...
                      <p className="ml-16 text-lg leading-6 font-medium text-gray-900">
                        Bajo costo fijo, no necesitas contar con infraestructura
                        y personal
                      </p>
                    </dt>
                    <dd className="mt-2 ml-16 text-base text-gray-500">
              ...
              <div className="mt-10 -mx-4 relative lg:mt-0" aria-hidden="true">
                ...
                <img
                  ...
                  width="490"
                  src="./assets/beneficios-empresas.jpg"
                  alt=""
                />
              </div>
            </div>
              ...
              <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
                  ...
                  <dl className="mt-10 space-y-10">
                    <div className="relative">
                      <dt>
                        ...
                        <p className="ml-16 text-lg leading-6 font-medium text-gray-900">
                          Tendrás un equipo legal al alcance de tu mano
                        </p>
                      </dt>
                      <dd className="mt-2 ml-16 text-base text-gray-500">
                    ...
                    <div className="relative">
                      <dt>
                        ...
                        <p className="ml-16 text-lg leading-6 font-medium text-gray-900">
                          Realiza tus consultas legales sin necesidad de agendar
                          una cita
                        </p>
                      </dt>
                      <dd className="mt-2 ml-16 text-base text-gray-500">
                ...
                <div className="mt-10 -mx-4 relative lg:mt-0 lg:col-start-1">
                  ...
                  <img
                    className="relative mx-auto rounded-md"
                    width="490"
                    src="./assets/beneficios-personas.jpg"
                    alt=""
                  />
                </div>
              </div>
